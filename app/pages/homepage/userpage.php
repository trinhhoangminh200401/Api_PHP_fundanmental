        ...
        <div class="main  bg-grandient-search postition-relative">
            <div class="icontainer-search-form">
                <div class="mx-auto ipt-12 ipb-16 ipy-md-16">
                    ...
                    <?php endif; ?>
                    <form action="/app/pages/job/job.php" method="get">
                        <div class="search-box d-flex justify-content-center">
                            ...
                            <div class="d-flex flex-grow-1">
                                <div class="search-keyword w-100 mx-2">
                                    <input type="text" class="form-control inputsearch h-100" name='keyword' placeholder="Recipient's username" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                </div>
